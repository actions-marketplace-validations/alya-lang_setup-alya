...
|:---|:---|:---|
| `version` | The resolved Alya compiler version | `0.0.15` |
| `alyac-path` | Directory path containing the `alyac` binary | `/home/runner/.alyac/0.0.15/x86_64-linux` |
